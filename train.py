...
parser.add_argument('--dataset_name', default='my_dataset', type=str)  # 
parser.add_argument('--data_path', default='../data/my_dataset', type=str)  # 数据集路径
...
def get_data():
    ...
    data_bundle = pipe.process_from_file(data_path, demo=demo)  # 修改为动态的 `data_path`
